...
// Coded by kei
  ...
  const entry = await client.guilds.cache.get(cfg.Server.GuildID).fetchAuditLogs({type: 'CHANNEL_CREATE'}).then(audit => audit.entries.first())
